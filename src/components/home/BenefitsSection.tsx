...
const benefits = [{
  icon: <div className="flex flex-col items-center w-full">
            <a href="https://www.trustpilot.com/review/cutsforcreators.com" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button variant="outline" className="w-full bg-[#00b67a] hover:bg-[#00a06d] text-white border-none group flex justify-center gap-2 py-5">
...
const BenefitsSection = () => {
  return <section className="py-20 relative overflow-visible bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => <div key={benefit.title} className="group relative bg-[#1A1F2C]/50 border border-purple-500/10 rounded-2xl p-6 hover:border-purple-500/20 transition-all duration-300 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                {index === 0 ? <div className="mb-4 flex justify-center">
                    {benefit.icon}
                  </div> : <div className="mb-4 transform group-hover:scale-105 group-hover:rotate-2 transition-all duration-500">
                    {benefit.icon}
                  </div>}
